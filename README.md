...
*   **5-10 of a Kind:** A block configuration containing between 5 and 10 total occurrences of the same single digit anywhere in the sequence (e.g., `83858828`).
*   **4-8 Zeroes:** Highly sought-after blocks that terminate directly with between 4 and 8 consecutive trailing zeros (e.g., `84200000`).
...
*   **Prime Mystic:** A block number that has no positive divisors other than $1$ and itself.
